...
class PostsControllerTest < ActionController::TestCase
  ...
  test 'should update post' do
    ...
    json = JSON.parse response.body
    json.delete 'created_on'
    expected = {"id"=>339078012, "title"=>"哈囉", "content"=>"<p>世界</p>", "summary"=>"世界", "first_photo"=>{"id"=>339078012, "image_url"=>"http://localhost:3000/uploads/photos/image/339078012/tony.jpg", "thumb"=>"http://localhost:3000/uploads/photos/image/339078012/thumb_tony.jpg", "ziltaggings"=>[{"id"=>339078012, "x"=>20, "y"=>20, "post_id"=>339078012}]}}
    assert_equal expected, json
  end
