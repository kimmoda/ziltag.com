...
class PhotoTest < ActiveSupport::TestCase
  ...
  def test_same_domain
    stub_request_for_image
    p1 = Photo.find_or_create_by_source_and_href_and_token! 'http://webmock.me/jpeg', 'http://webmock.me/aaa', 'tonytonyjan'
    p2 = Photo.find_or_create_by_source_and_href_and_token! 'http://webmock.me/jpeg', 'http://webmock.me/bbb', 'tonytonyjan'
    assert_equal p1, p2
    p3 = Photo.find_or_create_by_source_and_href_and_token! 'http://webmock.me/jpeg', 'http://webmock.tw/bbb', 'tonytonyjan'
    refute_equal p1, p3
  end
