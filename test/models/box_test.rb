...
class BoxTest < ActiveSupport::TestCase
  ...
  def test_match_href
    box = Box.new(url: 'http://weihang.blogspot.tw')
    assert box.match_href? 'http://weihang.blogspot.tw/foo/bar'
    assert box.match_href? 'http://weihang.blogspot.jp/foo/bar'
    refute box.match_href? 'http://jian.blogspot.jp/foo/bar'
    box = Box.new(url: 'http://weihang.tumblr.com')
    assert box.match_href? 'http://weihang.tumblr.com/foo/bar'
  end

  def test_match_href_without_protocol
    box = Box.new(url: 'weihang.blogspot.tw')
    assert box.match_href? 'http://weihang.blogspot.tw/foo/bar'
    assert box.match_href? 'http://weihang.blogspot.jp/foo/bar'
    refute box.match_href? 'http://jian.blogspot.jp/foo/bar'
    box = Box.new(url: 'weihang.tumblr.com')
    assert box.match_href? 'http://weihang.tumblr.com/foo/bar'
  end
end
